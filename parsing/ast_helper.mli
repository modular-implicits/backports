...
module Typ :
  sig
    ...
    val arrow: ?loc:loc -> ?attrs:attrs -> arrow_flag -> core_type -> core_type
               -> core_type
...
module Exp:
  sig
    ...
    val fun_: ?loc:loc -> ?attrs:attrs -> arrow_flag -> expression option
              -> pattern -> expression -> expression
    val function_: ?loc:loc -> ?attrs:attrs -> case list -> expression
    val apply: ?loc:loc -> ?attrs:attrs -> expression
               -> (apply_flag * expression) list -> expression
...
module Cl:
  sig
    ...
    val apply: ?loc:loc -> ?attrs:attrs -> class_expr -> (apply_flag * expression) list -> class_expr
